...
> 完整分类索引见 [docs/README.md](docs/README.md)（文档中心，按主题分 7 类）
...
| [架构评估报告.md](docs/01-架构设计/架构评估报告.md) | 整体系统评分 92/100 + 架构说明 + 风险路线图 |
| [系统架构说明.md](docs/01-架构设计/系统架构说明.md) | 前后端架构、数据流、调用链 |
| [LLM策略与路由说明.md](docs/01-架构设计/LLM策略与路由说明.md) | LLM 策略、路由、容错、已知问题 |

### API 与数据库（`docs/02-API与数据库/`）

| 文档 | 内容 |
|------|------|
| [api-design.md](docs/02-API与数据库/api-design.md) | 全部 REST API 设计 |
| [数据库设计说明.md](docs/02-API与数据库/数据库设计说明.md) | MySQL 表结构、Redis Key、索引策略 |
| [数据库ER图.md](docs/02-API与数据库/数据库ER图.md) | 18 张表 ER 图（Mermaid） |
...
| 文档 | 内容 |
|------|------|
| [安全配置说明.md](docs/04-安全合规/安全配置说明.md) | JWT 鉴权、弱密钥校验、三层限流、DTO 校验、内容安全 |
| [安全合规说明.md](docs/04-安全合规/安全合规说明.md) | 安全扫描、秘钥管理、合规检查清单 |

### 测试与质量（`docs/05-测试与质量/`）

| 文档 | 内容 |
|------|------|
| [测试规范.md](docs/05-测试与质量/测试规范.md) | 测试分层、Mock 策略、空壳清理计划 |
| [压测与优化报告_20260811.txt](docs/05-测试与质量/压测与优化报告_20260811.txt) | 500 并发压测数据 + 性能优化 |
| [代码规范与质量说明.md](docs/05-测试与质量/代码规范与质量说明.md) | Checkstyle/PMD/SpotBugs 规范与使用 |

### 交付材料（`docs/06-交付材料/`）

| 文档 | 内容 |
|------|------|
| [项目概述.md](docs/06-交付材料/项目概述.md) | 项目目标用户、核心诉求、功能全景 |
| [Demo视频或原型内容.md](docs/06-交付材料/Demo视频或原型内容.md) | Demo 视频/原型脚本与样例输入输出 |
...
| 文档 | 内容 |
|------|------|
| [CHANGELOG-3.0.md](docs/07-变更与经验/CHANGELOG-3.0.md) | 版本变更记录、模块分工 |
| [MultiAgent升级实录_20260813.md](docs/07-变更与经验/MultiAgent升级实录_20260813.md) | Multi-Agent 并行工作流升级实录 |
| [博思AI智能体3.0最佳实践.md](docs/07-变更与经验/博思AI智能体3.0最佳实践.md) | AI 应用产品最佳实践实战总结 |

### 部署配置资产（`docs/` 根目录，供部署脚本引用）
