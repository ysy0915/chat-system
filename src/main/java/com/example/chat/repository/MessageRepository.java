...
public interface MessageRepository {
    ...
    @Select("SELECT id, question FROM messages WHERE (is_private IS NULL OR is_private = 0) AND answer_json IS NOT NULL AND answer_json != '' ORDER BY created_at DESC LIMIT 150")
